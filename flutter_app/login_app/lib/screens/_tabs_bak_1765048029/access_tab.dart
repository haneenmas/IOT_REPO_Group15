    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 24),
          const Text('One-Time Access Codes',
              style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
          const SizedBox(height: 12),
          SizedBox(
            width: double.infinity,
            child: ElevatedButton.icon(
              onPressed: () {
                final code = widget.doorbellService.generateOneTimeCode();
                showDialog(
                  context: context,
          ...
          TextButton(
            onPressed: () {
              if (nameCtrl.text.isNotEmpty) {
                ...
                setState(() => _users = widget.doorbellService.getAccessUsers());
